// llf-score/app/users-management.tsx
...
export default function UsersManagementScreen() {
  ...
  useEffect(() => {
    const loadToken = async () => {
      ...
      if (idToken) {
        ...
        const url = `${WEB_MANAGEMENT_URL}/users-management#auth_token=${encodeURIComponent(idToken)}`;
        setWebViewUrl(url);
      } else {
        // Без токена
        setWebViewUrl(`${WEB_MANAGEMENT_URL}/users-management`);
      }
    };
    loadToken();
  }, [getIdToken]);
  ...
  return (
    <Container style={styles.container} {...containerProps}>
      ...
      >
        <ModalHeader title="Управление пользователями" onClose={handleGoBack} />
      </LinearGradient>
