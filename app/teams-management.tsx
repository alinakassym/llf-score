// llf-score/app/teams-management.tsx
...
export default function TeamsManagementScreen() {
  ...
  useEffect(() => {
    const loadToken = async () => {
      ...
      if (idToken) {
        ...
        const url = `${WEB_MANAGEMENT_URL}/teams-management#auth_token=${encodeURIComponent(idToken)}`;
        setWebViewUrl(url);
      } else {
        // Без токена
        setWebViewUrl(`${WEB_MANAGEMENT_URL}/teams-management`);
      }
    };
    loadToken();
  }, [getIdToken]);
  ...
  return (
    <Container style={styles.container} {...containerProps}>
      ...
      >
        <ModalHeader title="Управление командами и игроками" onClose={handleGoBack} />
      </LinearGradient>
