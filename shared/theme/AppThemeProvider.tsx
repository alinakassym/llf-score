...
import { colors as tokens, typography, type ThemeTokens } from "./tokens";

let setNWColorScheme: ((m: "light" | "dark") => void) | null = null;
let NWStyleSheet: any = null;
try {
  setNWColorScheme = require("nativewind").setColorScheme;
} catch {}
try {
  NWStyleSheet = require("nativewind").NativeWindStyleSheet;
} catch {}

type Ctx = { colors: ThemeTokens; mode: "light" | "dark"; typography: any };
...
export function AppThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ThemeCtx.Provider value={{ colors, mode, typography }}>
